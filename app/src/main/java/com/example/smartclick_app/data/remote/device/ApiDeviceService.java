...
public interface ApiDeviceService {
    ...
    <T> LiveData<ApiResponse<RemoteResult<Object>>> executeAction(@Path("deviceId")String deviceId, @Path("actionName")String actionName,@Body RemoteAction<T> parameter);
